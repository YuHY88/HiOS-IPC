...
///*liufy add*/
///*----------------------------------------------------------------------------
// * Function : sockunion_get_port
// * Input    : su = Pointer to struct sockunion.
// * Output   : Returns the value of port.
// * Synopsis : This method returns the port number from the input su.
// * Callers  : 
// *--------------------------------------------------------------------------*/
//unsigned short
//sockunion_get_port (union sockunion *su)
//{
...
const char *
sockunion2str (const union sockunion *su, char *buf, int len)
{
...
//void
//sockunion_set(union sockunion *su, int family, const u_char *addr, int bytes)
//{
