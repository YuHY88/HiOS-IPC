...
zerror (const char *fname, int type, int size)
{
 ...
 */
void *
zrealloc (int type, void *ptr, int size)
{
  void *memory;
...
#ifdef MEMORY_LOG
struct mstat_t mstat[MTYPE_MAX];
...
void *
mtype_zmalloc (const char *file, int line, int type, int size)
{
  void *memory;
...
void *
mtype_zcalloc (const char *file, int line, int type, int size)
{
  void *memory;
...
void *
mtype_zrealloc (const char *file, int line, int type, void *ptr, int size)
{
  void *memory;
...
memory_init (void)
{
  install_element (CONFIG_NODE, &show_memory_cmd, CMD_LOCAL);
}
 ...
 */
const char *
mtype_memstr (char *buf, int len, unsigned long bytes)
{
  unsigned int m, k;
