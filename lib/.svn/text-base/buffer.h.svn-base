...
extern int buffer_pkt_send(uint32_t , uint16_t , uint16_t, uint16_t, struct send_type);

extern void buffer_data_delete (struct buffer *, struct buffer_data *);
...
extern buffer_status_t buffer_flush_all_ipc (struct buffer *b, uint32_t ip, uint16_t port, uint16_t vpn);

extern buffer_status_t buffer_flush_window_ipc (struct buffer *b, uint32_t ip, uint16_t port, uint16_t vpn, int width, int height, 
		     int erase_flag, int no_more_flag);

extern struct buffer_data* buffer_put_new_bufdata(struct buffer *b, const void *p, size_t *size);

extern void buffer_put_current_bufdata(struct buffer *b, const void *p, size_t *size);

extern buffer_status_t buffer_flush_available_ipc(struct buffer *b, uint32_t ip, uint16_t port, uint16_t vpn);
