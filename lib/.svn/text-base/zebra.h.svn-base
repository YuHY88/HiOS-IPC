...
struct in_pktinfo_sublimate	/*liufy modify: linux not miss struct in_pktinfo*/
{
  int ipi_ifindex;
...
typedef unsigned short zebra_size_t;
typedef unsigned short zebra_command_t;
typedef unsigned short vrf_id_t;  /* VRF ID type. */
