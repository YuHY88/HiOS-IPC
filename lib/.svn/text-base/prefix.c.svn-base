...
void
masklen_to_netip (const int masklen, struct in_addr *netmask)
{
...
/* Convert masklen into IP address's netmask (host byte order). */
void
masklen_to_hostip (const int masklen, struct in_addr *netmask)
{
  assert (masklen >= 0 && masklen <= IPV4_MAX_BITLEN);
