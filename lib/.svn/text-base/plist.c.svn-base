...
//  install_node (&prefix_node, config_write_prefix_ipv4);
  ...
  install_element (CONFIG_NODE, &ip_prefix_list_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ip_prefix_list_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ip_prefix_list_ge_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ip_prefix_list_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ip_prefix_list_le_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ip_prefix_list_seq_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ip_prefix_list_seq_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ip_prefix_list_seq_ge_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ip_prefix_list_seq_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ip_prefix_list_seq_le_ge_cmd, CMD_SYNC);

  install_element (CONFIG_NODE, &no_ip_prefix_list_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_prefix_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_ge_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_le_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_seq_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_seq_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_seq_ge_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_seq_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_seq_le_ge_cmd, CMD_SYNC);

  install_element (CONFIG_NODE, &ip_prefix_list_description_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_description_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_description_arg_cmd, CMD_SYNC);

  install_element (CONFIG_NODE, &ip_prefix_list_sequence_number_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ip_prefix_list_sequence_number_cmd, CMD_SYNC);

  install_element (CONFIG_NODE, &show_ip_prefix_list_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ip_prefix_list_name_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ip_prefix_list_name_seq_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ip_prefix_list_prefix_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ip_prefix_list_prefix_longer_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ip_prefix_list_prefix_first_match_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ip_prefix_list_summary_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ip_prefix_list_summary_name_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ip_prefix_list_detail_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ip_prefix_list_detail_name_cmd, CMD_LOCAL);

  install_element (CONFIG_NODE, &clear_ip_prefix_list_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &clear_ip_prefix_list_name_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &clear_ip_prefix_list_name_prefix_cmd, CMD_SYNC);
}
...
//  install_node (&prefix_ipv6_node, config_write_prefix_ipv6);
  ...
  install_element (CONFIG_NODE, &ipv6_prefix_list_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ipv6_prefix_list_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ipv6_prefix_list_ge_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ipv6_prefix_list_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ipv6_prefix_list_le_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ipv6_prefix_list_seq_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ipv6_prefix_list_seq_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ipv6_prefix_list_seq_ge_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ipv6_prefix_list_seq_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &ipv6_prefix_list_seq_le_ge_cmd, CMD_SYNC);

  install_element (CONFIG_NODE, &no_ipv6_prefix_list_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_prefix_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_ge_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_le_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_seq_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_seq_ge_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_seq_ge_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_seq_le_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_seq_le_ge_cmd, CMD_SYNC);

  install_element (CONFIG_NODE, &ipv6_prefix_list_description_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_description_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_description_arg_cmd, CMD_SYNC);

  install_element (CONFIG_NODE, &ipv6_prefix_list_sequence_number_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_ipv6_prefix_list_sequence_number_cmd, CMD_SYNC);

  install_element (CONFIG_NODE, &show_ipv6_prefix_list_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ipv6_prefix_list_name_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ipv6_prefix_list_name_seq_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ipv6_prefix_list_prefix_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ipv6_prefix_list_prefix_longer_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ipv6_prefix_list_prefix_first_match_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ipv6_prefix_list_summary_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ipv6_prefix_list_summary_name_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ipv6_prefix_list_detail_cmd, CMD_LOCAL);
  install_element (CONFIG_NODE, &show_ipv6_prefix_list_detail_name_cmd, CMD_LOCAL);

  install_element (CONFIG_NODE, &clear_ipv6_prefix_list_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &clear_ipv6_prefix_list_name_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &clear_ipv6_prefix_list_name_prefix_cmd, CMD_SYNC);
}
#endif /* HAVE_IPV6 */
