...
//  install_element (CONFIG_NODE, &route_map_cmd);
  install_element (CONFIG_NODE, &no_route_map_cmd, CMD_SYNC);
  install_element (CONFIG_NODE, &no_route_map_all_cmd, CMD_SYNC);
  ...
  install_element (CONFIG_NODE, &rmap_show_name_cmd, CMD_SYNC);
}
