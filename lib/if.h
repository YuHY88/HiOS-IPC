...
#define ZEBRA_IFC_QUEUED       (1 << 2)
  ...
  u_char flags;
#define ZEBRA_IFA_SECONDARY    (1 << 0)  // STATIC
#define ZEBRA_IFA_PEER         (1 << 1)  
#define ZEBRA_IFA_DHCP         (1 << 2)// DHCP
#define ZEBRA_IFA_UNNUMBERED   (1 << 3)  //UNNUMBERD
#define ZEBRA_IFA_SLAVE        (1 << 4)  //SLAVE
#define ZEBRA_IFA_LINK         (1 << 5)  //LINK_ADDRESS
