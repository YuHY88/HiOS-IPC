...
extern unsigned long stream_get_getp (struct stream *);
...
extern struct stream *stream_dupcat_offset(struct stream *s1, struct stream *s2,  size_t offset);

extern void stream_set_getp (struct stream *, unsigned long);
extern void stream_set_endp (struct stream *, unsigned long);
