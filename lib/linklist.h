...
#define listhead(X) ((NULL != X) ? ((X)->head) : NULL)
...
extern void listnode_add_prev (struct list *list, struct listnode *current, void *val);
extern void listnode_add_next (struct list *list, struct listnode *current, void *val);
extern void listnode_move_to_tail (struct list *, struct listnode *);
extern void listnode_delete (struct list *, void *);

/* 对链表节点的操作 */
extern void list_add_node(struct list *list, struct listnode *node);
extern void list_delete_node (struct list *, struct listnode *);
extern void list_detach_node(struct list *list, struct listnode *node);
...
extern void list_insert_bynode(struct list *, struct listnode *, struct listnode *);
extern void list_add_bynode(struct list *, struct listnode *);
extern void list_delete_bynode(struct list *, struct listnode *);
