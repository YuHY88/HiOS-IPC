...
distribute_list_init (int node)
{
  ...
  if(node==RIP_NODE) 
  {
    install_element (node, &distribute_list_all_cmd, CMD_SYNC);
    install_element (node, &no_distribute_list_all_cmd, CMD_SYNC);
    install_element (node, &distribute_list_cmd, CMD_SYNC);
    install_element (node, &no_distribute_list_cmd, CMD_SYNC);
    install_element (node, &distribute_list_prefix_all_cmd, CMD_SYNC);
    install_element (node, &no_distribute_list_prefix_all_cmd, CMD_SYNC);
    install_element (node, &distribute_list_prefix_cmd, CMD_SYNC);
    install_element (node, &no_distribute_list_prefix_cmd, CMD_SYNC);
  }
}
