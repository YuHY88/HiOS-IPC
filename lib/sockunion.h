...
//unsigned short sockunion_get_port (union sockunion *su);


/* Prototypes. */
extern int str2sockunion (const char *, union sockunion *);
extern const char *sockunion2str (const union sockunion *, char *, int);
...
//extern void sockunion_set(union sockunion *, int family, const u_char *addr, int bytes);
