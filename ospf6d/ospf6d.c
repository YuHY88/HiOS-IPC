...
static struct ospf6d_master ospf6_master;
...
parse_type_spec(int argc, const char *argv[])
{
    ...
    else if (! strcmp(argv[1], "as-external"))
    {
        type = htons(OSPF6_LSTYPE_AS_EXTERNAL);
    }
    else if (! strcmp(argv[1], "intra-prefix"))
    {
        type = htons(OSPF6_LSTYPE_INTRA_PREFIX);
    }
    else if (! strcmp(argv[1], "inter-router"))
    {
        type = htons(OSPF6_LSTYPE_INTER_ROUTER);
    }
    else if (! strcmp(argv[1], "inter-prefix"))
    {
...
static void
show_ipv6_ospf6_err (struct vty *vty, struct ospf6 *ospf6)
{
	char id[64];
	inet_ntop(AF_INET, &ospf6->router_id, id, sizeof(id));

    vty_out(vty, "    OSPF6 Instance %d Router ID %s%s",ospf6->ospf_id,
        id, VTY_NEWLINE);
    vty_out(vty, "       OSPF Error statictics%s%s",VTY_NEWLINE, VTY_NEWLINE);
    
    vty_out(vty, "General packet errors:%s",VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_bad_pkt_count, ospf6_err_str[0],
        ospf6->o6_err.receive_bad_version_count, ospf6_err_str[1], VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_bad_area_count, ospf6_err_str[2],
        ospf6->o6_err.receive_bad_vertual_count, ospf6_err_str[3], VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_pkt_small_count, ospf6_err_str[4],
        ospf6->o6_err.receive_transmit_count, ospf6_err_str[5], VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_bad_instance_count, ospf6_err_str[6],
        ospf6->o6_err.receive_down_count, ospf6_err_str[7], VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_neighbor_count, ospf6_err_str[8],
        ospf6->o6_err.receive_routerid_mismatch_count, ospf6_err_str[9], VTY_NEWLINE);
    
    /* hello */
    vty_out(vty, "%s", VTY_NEWLINE);
    vty_out(vty, "Hello Packet Errors :%s", VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_hello_mismatch_count, ospf6_err_str[10],
    ospf6->o6_err.receive_dead_mismatch_count, ospf6_err_str[11], VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_option_mismatch_count, ospf6_err_str[12],
    ospf6->o6_err.receive_virnei_mismatch_count, ospf6_err_str[13], VTY_NEWLINE);

    /* dd */
    vty_out(vty, "%s", VTY_NEWLINE);
    vty_out(vty, "DD Packet Errors :%s", VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_dd_neighbor_low_count, ospf6_err_str[14],
    ospf6->o6_err.receive_extern_option_count, ospf6_err_str[15], VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_lsack_unlsa_count, ospf6_err_str[16],
    ospf6->o6_err.receive_mtu_mismatch_count, ospf6_err_str[17], VTY_NEWLINE);

    /* lsack */
    vty_out(vty, "%s", VTY_NEWLINE);
    vty_out(vty, "LS Ack packet Errors :%s", VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_lsack_neighbor_low_count, ospf6_err_str[18],
    ospf6->o6_err.receive_bad_ack_count, ospf6_err_str[19], VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_dup_ack_count, ospf6_err_str[20],
    ospf6->o6_err.receive_lsack_unlsa_count, ospf6_err_str[21], VTY_NEWLINE); 

    /* lsr */
    vty_out(vty, "%s",VTY_NEWLINE);
    vty_out(vty, "LS REQ packet Errors :%s", VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_lsr_neighbor_low_count, ospf6_err_str[22],
    ospf6->o6_err.receive_bad_req_count, ospf6_err_str[23], VTY_NEWLINE);

    /* lsu */
    vty_out(vty, "%s", VTY_NEWLINE);
    vty_out(vty, "LS UPD packet Errors :%s", VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %-4d : %-30s%s", ospf6->o6_err.receive_lsu_lsa_check_count, ospf6_err_str[24],
    ospf6->o6_err.receive_less_recetlsa_count, ospf6_err_str[25], VTY_NEWLINE);
    vty_out(vty, " %-4d : %-30s  %s %-4d : %-30s%s", ospf6->o6_err.receive_lsu_unlsa_count, ospf6_err_str[26],  VTY_NEWLINE,
    ospf6->o6_err.receive_lsa_arrival_count, ospf6_err_str[27], VTY_NEWLINE);
     ...
     )
{
	...
	if(OSPF6_LSDB_SHOW_LEVEL_NORMAL == level)
		vty_out(vty, "Rtr - Router, Net - Network, Lnk - Link, INP - Intra-Prefix,%s          IAP - Inter-Prefix, IAR - Inter-Router, ASE - AS-External%s%s", VNL, VNL, VNL);
    ...
    for (ALL_LIST_ELEMENTS_RO(o->area_list, i, oa))
    {
        ...
        {
            ospf6_interface_name_simplify(oi->interface->name, if_name);
            vty_out(vty, IF_LSDB_TITLE_FORMAT, VNL,
                    if_name, oa->name, VNL, VNL);
...
ALIAS(show_ipv6_ospf6_database,
      ...
      "show ipv6 ospf6 [<1-255>] lsdb (detail|dump|internal)",
      SHOW_STR
      IPV6_STR
      OSPF6_STR
      OSPF6_INSTANCE
...
DEFUN(show_ipv6_ospf6_database_id,
      ...
      "show ipv6 ospf6 [<1-255>] lsdb * A.B.C.D",
      SHOW_STR
      IPV6_STR
      OSPF6_STR
      OSPF6_INSTANCE
...
ALIAS(show_ipv6_ospf6_database_id,
      ...
      "show ipv6 ospf6 [<1-255>] lsdb linkstate-id A.B.C.D",
      SHOW_STR
      IPV6_STR
      OSPF6_STR
      OSPF6_INSTANCE
     ...
     )
{
    ...
    //OSPF6_CMD_CHECK_RUNNING ();
    if ((inet_pton(AF_INET, argv[1], &adv_router)) != 1)
    {
...
ALIAS(show_ipv6_ospf6_database_router,
      ...
      "show ipv6 ospf6 [<1-255>] lsdb adv-router A.B.C.D",
      SHOW_STR
      IPV6_STR
      OSPF6_STR
      OSPF6_INSTANCE
...
DEFUN(show_ipv6_ospf6_database_id_router,
      ...
      "show ipv6 ospf6 [<1-255>] lsdb * A.B.C.D A.B.C.D",
      SHOW_STR
      IPV6_STR
      OSPF6_STR
      OSPF6_INSTANCE
...
DEFUN(show_ipv6_ospf6_database_adv_router_linkstate_id,
      ...
      "show ipv6 ospf6 [<1-255>] lsdb adv-router A.B.C.D linkstate-id A.B.C.D",
      SHOW_STR
      IPV6_STR
      OSPF6_STR
      OSPF6_INSTANCE
     ...
     )
{
    ...
    if (argc > 1)
    {
        ...
        ro = ospf6_route_lookup(&prefix, o->brouter_table);
...
ALIAS(show_ipv6_ospf6_border_routers,
      ...
      "show ipv6 ospf6 [<1-255>] border-routers (A.B.C.D|detail)",
      SHOW_STR
      IP6_STR
      OSPF6_STR
      OSPF6_INSTANCE
...
ALIAS(show_ipv6_ospf6_linkstate,
      ...
      "show ipv6 ospf6 [<1-255>] linkstate router A.B.C.D",
      SHOW_STR
      IP6_STR
      OSPF6_STR
      OSPF6_INSTANCE
...
ALIAS(show_ipv6_ospf6_linkstate,
      ...
      "show ipv6 ospf6 [<1-255>] linkstate network A.B.C.D A.B.C.D",
      SHOW_STR
      IP6_STR
      OSPF6_STR
      OSPF6_INSTANCE
...
DEFUN (show_ipv6_ospf6_error,
       show_ipv6_ospf6_error_cmd,
...
ospf6_init(void)
{
    ...
    install_element(CONFIG_NODE, &show_version_ospf6_cmd, CMD_LOCAL);
    install_element(OSPF6_NODE, &show_version_ospf6_cmd, CMD_LOCAL);
    install_element(CONFIG_NODE, &show_ipv6_ospf6_border_routers_cmd, CMD_LOCAL);
    install_element(OSPF6_NODE, &show_ipv6_ospf6_border_routers_cmd, CMD_LOCAL);
    install_element(CONFIG_NODE, &show_ipv6_ospf6_border_routers_detail_cmd, CMD_LOCAL);
    install_element(OSPF6_NODE, &show_ipv6_ospf6_border_routers_detail_cmd, CMD_LOCAL);
    install_element(CONFIG_NODE, &show_ipv6_ospf6_linkstate_cmd, CMD_LOCAL);
    install_element(OSPF6_NODE, &show_ipv6_ospf6_linkstate_cmd, CMD_LOCAL);
    install_element(CONFIG_NODE, &show_ipv6_ospf6_linkstate_router_cmd, CMD_LOCAL);
    install_element(OSPF6_NODE, &show_ipv6_ospf6_linkstate_router_cmd, CMD_LOCAL);
    install_element(CONFIG_NODE, &show_ipv6_ospf6_linkstate_network_cmd, CMD_LOCAL);
    install_element(OSPF6_NODE, &show_ipv6_ospf6_linkstate_network_cmd, CMD_LOCAL);
    install_element(CONFIG_NODE, &show_ipv6_ospf6_linkstate_detail_cmd, CMD_LOCAL);
    install_element(OSPF6_NODE, &show_ipv6_ospf6_linkstate_detail_cmd, CMD_LOCAL);
    install_element(CONFIG_NODE, &show_ipv6_ospf6_error_cmd, CMD_LOCAL);
    install_element(OSPF6_NODE, &show_ipv6_ospf6_error_cmd, CMD_LOCAL);

    install_element(CONFIG_NODE, &show_ipv6_ospf6_database_cmd, CMD_LOCAL);
    install_element(OSPF6_NODE, &show_ipv6_ospf6_database_cmd, CMD_LOCAL);

    //install_element(CONFIG_NODE, &show_ipv6_ospf6_database_detail_cmd, CMD_LOCAL);
    //install_element(OSPF6_NODE, &show_ipv6_ospf6_database_detail_cmd, CMD_LOCAL);

    install_element (OSPF6_NODE, &show_ipv6_ospf6_database_self_originated_cmd, CMD_LOCAL);
    install_element (CONFIG_NODE, &show_ipv6_ospf6_database_self_originated_cmd, CMD_LOCAL);
    
    install_element(CONFIG_NODE, &show_ipv6_ospf6_database_type_cmd, CMD_LOCAL);
    install_element(OSPF6_NODE, &show_ipv6_ospf6_database_type_cmd, CMD_LOCAL);

    install_element (OSPF6_NODE, &show_ipv6_ospf6_database_type_self_originated_cmd, CMD_LOCAL);
    install_element (CONFIG_NODE, &show_ipv6_ospf6_database_type_self_originated_cmd, CMD_LOCAL);
    ...
    //ospf6_serv_sock ();
    //thread_add_read (master_ospf6, ospf6_receive, NULL, ospf6_sock);
}
...
ospf6_clean(void)
{
    ...
    for (ALL_LIST_ELEMENTS(om6->ospf6, node, nnode, ospf6))
    {
        ...
        {
            ospf6_route_remove_all(ospf6->route_table, ospf6);
        }

        if (ospf6->brouter_table)
        {
            ospf6_route_remove_all(ospf6->brouter_table, ospf6);
        }
    }
}

static int
ospf6_id_cmp(struct ospf6 * o1, struct ospf6 *o2)
{
    if (o1->ospf_id > o2->ospf_id)
    {
        return 1;
    }
...
void
ospf6_master_init(void)
{
    memset(&ospf6_master, 0, sizeof(struct ospf6d_master));
    om6 = &ospf6_master;
    om6->ospf6 = list_new();
    om6->ospf6->cmp = (int (*)(void *, void *)) ospf6_id_cmp;
    om6->master = master_ospf6;

    /* init the redis count num */
    for (int i = 0; i <= ROUTE_PROTO_MAX; i++)
    {
        om6->redis_count[i] = 0;
    }

    FIFO_INIT(&om6->routefifo);			/*初始化本地待发送route fifo*/
    //FIFO_INIT(&om6->ifmfifo);			/*ipv4 时已经废除*/
    om6->t_thread_routefifo = 0;		/*异步发送route thread*/
	//om6->t_read_msg = NULL;
	//om6->t_read_pkt = NULL;
	
    om6->external6_table = OSPF6_ROUTE_TABLE_CREATE(GLOBAL, EXTERNAL_ROUTES);
    om6->external6_table->hook_add = NULL;
    om6->external6_table->hook_remove = NULL;
}
