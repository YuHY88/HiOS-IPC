...
struct ospf6_area
{
    ...
    struct thread  *thread_spf_calculation;		//no use
    struct thread  *thread_route_calculation;	//no use
...
extern void ospf6_area_config_write(struct vty *vty, struct ospf6 *);
