...
/* origination & purging */
extern void ospf6_lsa_originate(struct ospf6 *, struct ospf6_lsa *lsa);
...
extern void ospf6_flood_clear(struct ospf6_lsa *);
extern struct ospf6 *ospf6_get_instance_self(struct ospf6_lsa *);

extern void ospf6_flood(struct ospf6_neighbor *from, struct ospf6_lsa *lsa);

/* receive & install */
extern void ospf6_receive_lsa(struct ospf6 *ospf6, struct ospf6_neighbor *from,
