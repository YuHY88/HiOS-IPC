...
extern int ospf6_hello_send(void *thread);
extern int ospf6_dbdesc_send(void *thread);
extern int ospf6_dbdesc_send_newone(void *thread);
extern int ospf6_lsreq_send(void *thread);
extern int ospf6_lsupdate_send_interface(struct thread *thread);
extern int ospf6_lsupdate_send_neighbor(void *thread);
extern int ospf6_lsack_send_interface(void *thread);
...
//extern int ospf6_pkt_rcv(struct thread *);
extern int ospf6_pkt_rcv_new(struct ipc_mesg_n *pmsg);
