...
struct ospf6_neighbor
{
	...
	TIMERID inactivity_timer;

    /* Thread for sending message */
    //struct thread *thread_send_dbdesc;
	TIMERID thread_send_dbdesc;
    //struct thread *thread_send_lsreq;
	TIMERID thread_send_lsreq;
    //struct thread *thread_send_lsupdate;
	TIMERID thread_send_lsupdate;
    struct thread *thread_send_lsack;		//not timer
};
...
extern int inactivity_timer(void *);
extern void ospf6_check_nbr_loading(struct ospf6_neighbor *);
extern void ospf6_interface_name_simplify(char *, char if_name[]);
