...
{
    u_int32_t recv_all;
    u_int32_t send_statics;
    u_int32_t send_error;
    u_int32_t recv_statics;
    u_int32_t s_hel;
    u_int32_t s_dd;
    u_int32_t s_lsr;
    u_int32_t s_lsu;
...
extern int ospf_ls_upd_timer (void *);
extern int ospf_ls_ack_timer (void *);
extern int ospf_poll_timer (void *);
extern int ospf_hello_reply_timer (void *);
//extern int ospf_pkt_rcv(struct thread *thread);
extern int ospf_pkt_rcv_new(struct ipc_mesg_n *pmsg);
...
int ospf_hello(struct ip iph, struct ospf_header *ospfh, struct stream * s, struct ospf_interface *oi, int size);
int ospf_db_desc(struct ip iph, struct ospf_header *ospfh, struct stream *s, struct ospf_interface *oi, u_int16_t size);
int ospf_ls_req(struct ip iph, struct ospf_header *ospfh, struct stream *s, struct ospf_interface *oi, u_int16_t size);
int ospf_ls_upd(struct ospf *ospf, struct ip iph, struct ospf_header *ospfh, struct stream *s, struct ospf_interface *oi, u_int16_t size);
int ospf_ls_ack(struct ip iph, struct ospf_header *ospfh, struct stream *s, struct ospf_interface *oi, u_int16_t size);
