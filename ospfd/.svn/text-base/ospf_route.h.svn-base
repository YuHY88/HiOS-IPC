...
extern void ospf_route_delete (struct route_table *,struct ospf*);
...
extern int ospf_add_discard_route (struct route_table *, struct ospf_area *,
                                   struct prefix_ipv4 *);
extern void ospf_delete_discard_route (struct ospf *, struct route_table *, struct prefix_ipv4 *);
extern int ospf_route_match_same (struct route_table *, struct prefix_ipv4 *,
                                  struct ospf_route *,struct ospf *);
extern void ospf_route_delete_by_area(struct ospf_area *, struct route_table *);
