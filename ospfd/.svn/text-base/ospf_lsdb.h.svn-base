...
extern void ospf_lsdb_delete_all_ex_net (struct ospf_lsdb *);
...
extern void ospf_area_self_lsdb_discard(struct ospf_area *);
extern void ospf_lsdb_discard(struct ospf *);
extern void ospf_reset_area(struct ospf_area * area);
