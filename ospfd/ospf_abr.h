...
extern int ospf_area_range_unset (struct ospf *, struct in_addr,
                                  struct prefix_ipv4 *);
extern void ospf_area_range_table_free (struct route_table *);
...
extern int ospf_abr_nssa_translate_type7totype5 (struct ospf_area *, struct ospf_lsa *);

extern int ospf_abr_nssa_am_elected (struct ospf_area *);
extern void ospf_check_abr_status (struct ospf *);
extern void ospf_abr_nssa_check_status (struct ospf *);
//extern void ospf_abr_nssa_task (struct ospf *);
