...
extern int ecommunity_include (const struct ecommunity *, const struct ecommunity *);
extern struct ecommunity *ecommunity_rt_add (struct ecommunity *, struct ecommunity *);
