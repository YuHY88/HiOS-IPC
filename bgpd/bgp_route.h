...
#define BGP_TAG_IS_EMPTY(tag) (!(tag)[0] && !(tag)[1] && !(tag)[2])
...
#define BGP_INFO_EXTRA_TAG_BOTTOM_BIT  (1u << 0)
...
#define BGP_INFO_DELETE         (1 << 13)
#define BGP_INFO_TARGET         (1 << 14)
...
struct bgp_static
{
    struct bgp_static *prev;
    struct bgp_static *next;
...
extern void bgp_default_originate (struct peer *, afi_t, safi_t, int, int);
...
extern int bgp_fsm_change_base_interface(struct prefix *,int , uint16_t);
extern int bgp_fsm_change_base_route(struct prefix *p , uint16_t);
extern void bgp_network_add(struct bgp *, struct bgp_static *, struct prefix *, afi_t , safi_t);
extern void bgp_network_delete(struct bgp *, struct prefix *, afi_t , safi_t);
extern void bgp_redistribute_add (struct prefix *, const struct in_addr *,const struct in6_addr *, u_int32_t, u_char, u_int32_t,uint8_t);
extern void bgp_redistribute_delete (struct prefix *, u_char,uint8_t);

extern void bgp_redistribute_vrf_add (struct prefix *, const struct in_addr *, u_int32_t , u_char , u_int32_t ,uint8_t ,uint16_t );
extern void	bgp_redistribute_vrf_delete (struct prefix *, struct bgp *, afi_t , int , uint8_t , u_int16_t );

extern void bgp_redistribute_route_add_type (struct bgp *, afi_t , u_char , uint8_t ,uint16_t);
extern void bgp_redistribute_route_delete_type (struct bgp *, afi_t, int, uint8_t, uint16_t);
extern void bgp_route_add (struct prefix *, struct zapi_route *);
extern void bgp_route_delete(struct prefix *, struct zapi_route *);
extern void bgp_route_delete_all(struct bgp_table *);
...
extern int bgp_process_announce_selected (struct peer *, struct bgp_info *,
                               struct bgp_node *, afi_t , safi_t);
...
extern void bgp_config_write_ipv6_family (struct vty *, struct bgp *, afi_t , safi_t , int *);
extern void bgp_config_write_distance (struct vty *, struct bgp *);
...
extern void bgp_med_update(struct bgp *, afi_t , safi_t);
extern void bgp_local_pref_update(struct bgp *, afi_t , safi_t);
