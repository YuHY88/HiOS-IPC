...
EOF
$ignore{'"interface (ethernet|tdm|stm) USP"'} = "ignore";
$ignore{'"interface tunnel USP"'} = "ignore";
$ignore{'"interface loopback <0-128>"'} = "ignore";
$ignore{'"interface vlanif <1-4095>"'} = "ignore";
$ignore{'"interface trunk TRUNK"'} = "ignore";
$ignore{'"ip address A.B.C.D/<1-32>"'} = "ignore";
$ignore{'"no ip address A.B.C.D/<1-32>"'} = "ignore";
$ignore{'"mode switch"'} = "ignore";
$ignore{'"mode (l2|l3)"'} = "ignore";
$ignore{'"acl NAME"'} = "ignore";
...
foreach (@ARGV) {
    ...
    open (FH, "ppc_85xxDP-gcc -E -DHAVE_CONFIG_H -DVTYSH_EXTRACT_PL -DHAVE_IPV6 -I.. -I./ -I./.. -I../lib -I../lib -I../isisd/topology  $file |");
    local $/; undef $/;
    $line = <FH>;
    close (FH);
