...
struct isis_statistics
{
	u_int32_t isis_send;
	u_int32_t isis_rcv;
	u_int32_t isis_route;
	u_int32_t isis_lsp_send;
	u_int32_t isis_lsp_recv;
	u_int32_t isis_csnp_send;
	u_int32_t isis_csnp_recv;
	u_int32_t isis_psnp_send;
	u_int32_t isis_psnp_recv;
	u_int32_t isis_route_add_merge;
	u_int32_t isis_route_del_merge;
