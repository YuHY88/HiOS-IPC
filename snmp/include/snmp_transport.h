...
extern oid      netsnmpIPCDomain[]; 	/*      = { 1, 3, 6, 1, 6, 1, 7 };  */
...
extern size_t   netsnmpIPCDomain_len;
...
typedef struct netsnmp_transport_s {
    ...
    int is_ipc_trap ;//added by lidingcheng for trap send seesion don't receive snmp	
} netsnmp_transport;
