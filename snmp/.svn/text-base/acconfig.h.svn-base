...
#define SYSTEM_INCLUDE_FILE <generic.h>
...
#define ENTERPRISE_OID			9966
#define ENTERPRISE_MIB			1,3,6,1,4,1,9966
#define ENTERPRISE_DOT_MIB		1.3.6.1.4.1.9966
#define ENTERPRISE_DOT_MIB_LENGTH	7

/* The assigned enterprise number for sysObjectID. */
#define SYSTEM_MIB		1,3,6,1,4,1,9966,3,2,OSTYPE
#define SYSTEM_DOT_MIB		1.3.6.1.4.1.9966.3.2.OSTYPE
#define SYSTEM_DOT_MIB_LENGTH	10

/* The assigned enterprise number for notifications. */
#define NOTIFICATION_MIB		1,3,6,1,4,1,9966,4
#define NOTIFICATION_DOT_MIB		1.3.6.1.4.1.9966.4
...
/* this is the location of the net-snmp mib tree.  It shouldn't be
   changed, as the places it is used are expected to be constant
   values or are directly tied to the UCD-SNMP-MIB. */
#define NETSNMP_OID		9966
#define NETSNMP_MIB		1,3,6,1,4,1,9966
#define NETSNMP_DOT_MIB		1.3.6.1.4.1.9966
