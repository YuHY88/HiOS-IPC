...
ripng_debug_init()
{
    ...
    install_element(VIEW_NODE, &show_debugging_ripng_cmd, CMD_LOCAL);
#if 0
    ...
    install_element(CONFIG_NODE, &debug_ripng_packet_direct_cmd, CMD_SYNC);
    install_element(CONFIG_NODE, &debug_ripng_packet_detail_cmd, CMD_SYNC);
    install_element(CONFIG_NODE, &debug_ripng_zebra_cmd, CMD_SYNC);
    ...
    install_element(CONFIG_NODE, &no_debug_ripng_packet_direct_cmd, CMD_SYNC);
    install_element(CONFIG_NODE, &no_debug_ripng_zebra_cmd, CMD_SYNC);
}
