...
zebra_init(struct thread_master *master)
{
    ...
    install_element(CONFIG_NODE, &router_zebra_cmd, CMD_SYNC);
    install_element(CONFIG_NODE, &no_router_zebra_cmd, CMD_SYNC);
    install_default(ZEBRA_NODE);
    install_element(ZEBRA_NODE, &ripng_redistribute_ripng_cmd, CMD_SYNC);
    install_element(ZEBRA_NODE, &no_ripng_redistribute_ripng_cmd, CMD_SYNC);

    /* Install command elements to ripng node */
    install_element(RIPNG_NODE, &ripng_redistribute_type_cmd, CMD_SYNC);
    install_element(RIPNG_NODE, &ripng_redistribute_type_routemap_cmd, CMD_SYNC);
    install_element(RIPNG_NODE, &ripng_redistribute_type_metric_cmd, CMD_SYNC);
    install_element(RIPNG_NODE, &ripng_redistribute_type_metric_routemap_cmd, CMD_SYNC);
    install_element(RIPNG_NODE, &no_ripng_redistribute_type_cmd, CMD_SYNC);
    install_element(RIPNG_NODE, &no_ripng_redistribute_type_routemap_cmd, CMD_SYNC);
    install_element(RIPNG_NODE, &no_ripng_redistribute_type_metric_cmd, CMD_SYNC);
    install_element(RIPNG_NODE, &no_ripng_redistribute_type_metric_routemap_cmd, CMD_SYNC);
}
