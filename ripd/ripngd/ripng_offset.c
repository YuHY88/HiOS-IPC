...
ripng_offset_init(void)
{
    ...
    install_element(RIPNG_NODE, &ripng_offset_list_cmd, CMD_SYNC);
    install_element(RIPNG_NODE, &ripng_offset_list_ifname_cmd, CMD_SYNC);
    install_element(RIPNG_NODE, &no_ripng_offset_list_cmd, CMD_SYNC);
    install_element(RIPNG_NODE, &no_ripng_offset_list_ifname_cmd, CMD_SYNC);
}
#endif
void
