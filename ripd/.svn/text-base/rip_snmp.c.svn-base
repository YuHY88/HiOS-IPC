            ...
            int exact, size_t *var_len, WriteMethod **write_method)
{
    ...
    switch (v->magic)
    {
        case RIP2GLOBALROUTECHANGES:
            return SNMP_INTEGER(rip_global_route_add);
            break;
...
rip2PeerLookup(struct rip_instance *rip, struct variable *v, oid name[], size_t *length,
               struct in_addr *addr, int exact)
{
    int len;
                ...
                int exact, size_t *var_len, WriteMethod **write_method)
{
    ...
    switch (v->magic)
    {
        ...
        case RIP2IFSTATRCVPACKETS:
            *var_len = sizeof(long);
            return (u_char *) &ri->receive_packet;
              ...
              int exact, size_t *val_len, WriteMethod **write_method)
{
    ...
    /* Lookup interface. */
    peer = rip2PeerLookup(rip, v, name, length, &addr, exact);
